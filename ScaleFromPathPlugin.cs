...
namespace veasu.scalebypath {
  [PluginType(Id = "com.veasu.scalebypath", 
  Name = "Scale From Path Plugin", 
  Description = "Scale From Path Plugin", 
  Author = "Veasu", 
  Version = "0.1.0", 
  ...
  NodeTypes = new System.Type[] {typeof (ScaleByPathNode)})]
  public class ScaleByPathPlugin : Plugin
  {
  }
